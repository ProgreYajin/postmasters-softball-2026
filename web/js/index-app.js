        ...
        <div class="game-section" onclick="window.location.href='scoreboard.html';">
            ...
            <div class="score-summary">
                <div class="score-display">
                    <div class="team-side">
                        <div class="team-name-compact">${escapeHtml(team1.name)}</div>
                    </div>
                    ...
                    <div class="team-side">
                        <div class="team-name-compact">${escapeHtml(team2.name)}</div>
                    </div>
                </div>
            </div>
        </div>
...
function renderNextGameCard(gameGroups) {
    ...
    if (nextGameList.length >= 2) {
        ...
        // 開始予定時刻を複数のキーから取得
        let startTime = getSafeValue(nextGameList[0], 'startTime', 'StartTime', 'start_time', 'lastUpdate', 'timestamp');
        let timeText = '';
